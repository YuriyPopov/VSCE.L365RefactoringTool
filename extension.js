...
function activate(context) {
	...
	let disposable = vscode.commands.registerCommand('refactoring-tool-l365.set-action-tooltip-doc', () => {processCurrDocument(applyActionTooltip);});
	context.subscriptions.push(disposable);

	disposable = vscode.commands.registerCommand('refactoring-tool-l365.set-action-tooltip-worksp', () => {processCurrWorkspace(applyActionTooltip);});
	context.subscriptions.push(disposable);

	disposable = vscode.commands.registerCommand('refactoring-tool-l365.set-field-tooltip-doc', () => {processCurrDocument(applyFieldTooltip);});
	context.subscriptions.push(disposable);

	disposable = vscode.commands.registerCommand('refactoring-tool-l365.set-field-tooltip-worksp', () => {processCurrWorkspace(applyFieldTooltip);});
	context.subscriptions.push(disposable);
}
